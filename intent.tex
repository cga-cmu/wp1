...
% we want f(t). We also want desired motion.
% for optimization
% force is predicted
% force(t)
% force(q,qd,qdd,t) is predicted.
% or qdd_d and W_qdd, f_ox and W_f_ox, f_ow and W_f_ow
% where does the operator want to go p(q(t)) and utility (one step cost) and value function
% what forces will the operator apply? p(f(t)) and utility (one step cost) and value function
