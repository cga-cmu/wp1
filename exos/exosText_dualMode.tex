...
The mechanical as well as control design of the Hydraulic Lower Extremity Exoskeleton was straight-forward and contained many aspects which we support.  In particualr, we supported the use of off-the-shelf components in the hardware design and the addition of bypass valves to take advantage of passive dynamics during walking to produce more energy conscious behaviors.    
